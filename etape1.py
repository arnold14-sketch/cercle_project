            ...
            for i in range(nbre_cercle):
                while True:
                    ...
                    if add in cercle_list:
                        print(
                            "Un cercle porte déjà ce nom,merci de renseigner un autre nom"
                        )
                    else:
            ...
            for j in range(nbre_membre):
                while True:
                    ...
                    for (
                        cle,
                        lst,
                    ) in cercles_dict.items():  # creer une liste de tous les membres
                        k = 0
                        for l in lst:
                            check.append(lst[k])
                            k = +1
                    ...
                    if (
                        add in check
                    ):  # verifie si le membre existe dans la liste globale crée
                        print("Cette personne est déjà membre d'un cercle ")
                    else:
                        cercles_dict[cercle].append(
                            add
                        )  # ajoute le membre dans le dict si inexistant
                        print(
                            add
                            + " a bien été ajouté dans la liste des membres du cercle "
                            + cle
                        )
                        break
...
def suppression_membre(nbre_membre, cercle, cercles_dict):
    try:
        nbre_membre = int(nbre_membre)
        for j in range(nbre_membre):
    ...
    while True:
        ...
        while True:  # boucle sur le programme tant que l'option quitté n'est pas activé
            ...
            try:
                ...
                if enter < 0 or enter > 5:  # verifie que le choix de l'input du menu
                    print(
                        "merci de renseigner un chiffre present dans le menu soit de 0 à 5"
                    )
            except ValueError:
                print("Merci de renseigner un entier")
            break
        ...
        if enter == 2:
            if cercle_list == []:
                ...
                while (
                    True
                ):  # boucle tant que le nom de cercle rensigné n'est pas correcte
                    cercle = input(
                        "Dans quel cercle souhaitez-vous rajouter des membres?"
                    )
                    ...
                    if confirmation == 0:
                        while True:  # boucle tant que les membres ne sont pas crées
                            m = input(
                                "combien de membres souhaitez-vous pour le cercle "
                                + cercle
                                + " ?"
                            )
                            cercles_dict, controle_main2 = ajout_membre(
                                m, cercle, cercles_dict
                            )
                            if controle_main2 == 0:
                                break
                        break
                ...
                while True:  # boucle tant que le nom de cercle est inexistant
                    ...
                    if confirmation == 0:
                        while True:  # boucle tant que les membres ne sont pas rajoutés
                            s = input(
                                "combien de membres souhaitez-vous supprimer du cercle "
                                + cercle
                                + " ?"
                            )
                            cercles_dict, controle_main3 = suppression_membre(
                                s, cercle, cercles_dict
                            )
                            if controle_main3 == 0:
                                break
                        break
        ...
        while True:  # Boucle tant que le choix n'est pas entre 0 et 1
            decision = input(
                "Souhaitez-vous continuez? Si oui taper 0 sinon taper 1:   "
            )
            try:
